...
create unique index ix_review on Review (book_id, username);
...
create unique index ix_evaluate_review on Evaluate_Review (review_id, username);
...
create unique index ix_rating_book on Rating_Book (book_id, username);
